...
public class MaquinaAdminPresenter implements MaquinaAdminContract.Presenter{
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    String seccionMaquina = snapshot.child(SECCION).getValue(String.class);
                    String areaMaquina = snapshot.child(AREA).getValue(String.class);
                    String descripcionMaquina = snapshot.child(DESCRIPCION).getValue(String.class);
                    // Notificar a la vista con los detalles
                    view.showDetallesMaquinaSeleccionada(nombreMaquina, equipoMaquina, seccionMaquina, areaMaquina, descripcionMaquina);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
    ...
    @Override
    public void agregarMaquina(String nombre, String equipo, String seccion, String area, String descripcion) {
        // Validar los datos (puedes agregar más validaciones según tus necesidades)
        if (nombre.isEmpty() || equipo.isEmpty() || seccion.isEmpty() || area.isEmpty() || descripcion.isEmpty()) {
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        Maquina maquina = new Maquina(nombre,equipo,seccion,area,descripcion);
    ...
    @Override
    public void editarMaquina(String nombre, String equipo, String seccion, String area, String descripcion) {
        // Validar los datos (puedes agregar más validaciones según tus necesidades)
        if (nombre.isEmpty() || equipo.isEmpty() || seccion.isEmpty() || area.isEmpty() || descripcion.isEmpty()) {
            view.showErrorMessage("Todos los campos son obligatorios");
            return;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    Maquina maquinaActualizada = new Maquina(nombre, equipo, seccion, area, descripcion);
                    snapshot.getRef().setValue(maquinaActualizada);
