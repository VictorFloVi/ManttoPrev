...
public class MaquinaAdmin extends AppCompatActivity implements MaquinaAdminContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cboMaquinaSeccion = findViewById(R.id.cboMaquinaSeccion);
        ...
        btnAgregarMaquina.setOnClickListener(v -> {
            ...
            String seccion = cboMaquinaSeccion.getSelectedItem().toString().trim();
            String area = cboMaquinaArea.getSelectedItem().toString().trim();
            String descripcion = etDescripcionMaquina.getText().toString().trim();
            presenter.agregarMaquina(maquina, equipo, seccion, area, descripcion);
        });

        btnConsultarMaquina.setOnClickListener(v -> {
            String nombreMaquina = etMaquina.getText().toString().trim();
            presenter.consultarMaquina(nombreMaquina);
        });
        ...
        btnEditarMaquina.setOnClickListener(v -> {
            ...
            String area = cboMaquinaArea.getSelectedItem().toString().trim();
            String descripcion = etDescripcionMaquina.getText().toString().trim();
            presenter.editarMaquina(nombre, equipo, seccion, area, descripcion);
        });
    ...
    public void clearEditTextFields() {
        ...
        cboMaquinaSeccion.setSelection(0);
        cboMaquinaEquipo.setSelection(0);
        etDescripcionMaquina.setText("");
    }

    @Override
    public void showDetallesMaquinaSeleccionada(String nombreMaquina, String equipoMaquina, String seccionMaquina, String areaMaquina, String descripcionMaquina) {
        ...
        int indexs = obtenerIndiceSeccion(seccionMaquina);
        int indexa = obtenerIndiceArea(areaMaquina);
        cboMaquinaEquipo.setSelection(index);
        cboMaquinaSeccion.setSelection(indexs);
    ...
    private int obtenerIndiceSeccion(String seccion) {
        ArrayAdapter<String> adapter = (ArrayAdapter<String>) cboMaquinaSeccion.getAdapter();
    ...
    public void showConsultarMaquina(Maquina maquina) {
        ...
        int indexs = obtenerIndiceSeccion(maquina.getSeccion());
    ...
    public void mostrarSecciones(List<String> secciones) {
        ...
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        cboMaquinaSeccion.setAdapter(adapter);
    }
